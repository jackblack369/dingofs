...
#include "src/options/common/dynamic_vlog.h"

#ifndef DINGOFS_SDK_LIBDINGOFS_ERROR_LOG_H_
#define DINGOFS_SDK_LIBDINGOFS_ERROR_LOG_H_
...
#endif  // DINGOFS_SDK_LIBDINGOFS_ERROR_LOG_H_
